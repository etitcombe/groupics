...
func TestShow(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid ID", "/show/1", http.StatusOK, []byte("An old silent pond...")},
		{"Non-existent ID", "/show/2", http.StatusNotFound, nil},
		{"Negative ID", "/show/-1", http.StatusNotFound, nil},
		{"Decimal ID", "/show/1.23", http.StatusNotFound, nil},
		{"String ID", "/show/foo", http.StatusNotFound, nil},
		{"Empty ID", "/show/", http.StatusNotFound, nil},
		{"Trailing slash", "/show/1/", http.StatusNotFound, nil},
	}
