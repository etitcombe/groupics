...
func (app *application) routes() http.Handler {
	...
	mux.Get("/create", app.session.Enable(app.requireAuthentication(http.HandlerFunc(app.createForm))))
	mux.Post("/create", app.session.Enable(app.requireAuthentication(http.HandlerFunc(app.create))))
	...
	mux.Post("/logout", app.session.Enable(app.requireAuthentication(http.HandlerFunc(app.logout))))
	mux.Get("/refresh", app.session.Enable(app.requireAuthentication(http.HandlerFunc(app.refresh))))
